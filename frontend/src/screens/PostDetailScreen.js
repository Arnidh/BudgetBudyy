...
const PostDetailScreen = ({ navigation, route }) => {
  ...
  const [likeButton, setLikeButton] = postInfo.didCurrUserLike
    ? useState("like1")
    : useState("like2");
  ...
  const likeBtnPressed = async (didLike) => {
    try {
      ...
      didLike ? setLikesNum(likesNum + 1) : setLikesNum(likesNum - 1);
    } catch (err) {
      console.log(err);
    }
  };
        ...
        <View style={[styles.postContainer]}>
          <View style={styles.postHeader}>
            ...
            <Image
              ...
              source={{ url: postInfo.userAvatar }}
            />
            <View>
              <Text
                style={[
          ...
          <View style={styles.likeCommentContainer}>
            ...
            <View style={styles.commentContainer}>
              <TouchableOpacity activeOpacity={0.7} onPress={fetchComments}>
